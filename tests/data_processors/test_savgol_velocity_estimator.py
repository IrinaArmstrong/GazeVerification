...
from gaze_verification.data_processors.velocity_estimators import SavitzkyGolayVelocityEstimator
...
class TestSavitzkyGolayVelocityEstimator(unittest.TestCase):
    ...
    def test_compute_velocity_sample(self):
        ...
        self.assertTupleEqual(velocity_sample[0].data.shape, (n_elements, n_dims))
